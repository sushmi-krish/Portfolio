...
const project= [
    {
        ...
        image: `${process.env.PUBLIC_URL}/ePlantShopping.PNG`,
     ...
     },
   {
        ...
        image: `${process.env.PUBLIC_URL}/voyagarVacation.PNG`,
   ...
   },
   {
        ...
        image: `${process.env.PUBLIC_URL}/eventPlanner.PNG`,
 ...
 {   
        ...
        image: `${process.env.PUBLIC_URL}/GiftLinks.PNG`,
        link:"",
    ...
    },
    {
        ...
        image: `${process.env.PUBLIC_URL}/vendorPayment.PNG`,
        link:"",
    ...
    },
    {
        ...
        image: `${process.env.PUBLIC_URL}/friendCRUD.PNG`,
        link:"",
    ...
    },
    {
        ...
        image: `${process.env.PUBLIC_URL}/TaxCalculator.PNG`,
        link:"",
                        ...
                        {project.map((project) => (
                            <div key={project.id} className="portfolio-project">
                                ...
                                <p>{project.description}</p>
                                  <a href={project.link ? project.link : project.gitHub} target="_blank" rel="noopener noreferrer">Live Demo</a>
